...
async function getBusiness(id: string): Promise<Business | null> {
  ...
  const res = await fetch(
    `${SUPABASE_URL}/rest/v1/businesses?id=eq.${id}&select=id,name,phone,phone_is_whatsapp,whatsapp_phone,address,description,photo_url,is_verified,has_delivery,categories!businesses_category_id_fkey(id,name)&limit=1`,
    {
      headers: {
